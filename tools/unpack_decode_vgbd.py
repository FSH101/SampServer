...
To ship as a single Windows .exe (no Python install for users):
  pip install pyinstaller
  pyinstaller --onefile --noconsole unpack_decode_vgbd.py
(Use --noconsole only if you rely on --gui; otherwise omit it to see logs.)
"""
